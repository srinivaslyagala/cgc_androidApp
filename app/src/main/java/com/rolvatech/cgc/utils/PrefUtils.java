...
public class PrefUtils {
    ...
    public static final String INSTITUTE_ADDRESS = "institueAddress";
    public static final String INSTITUTE_EMAIL = "email";
    public static final String INSTITUTE_CONTACT = "contact";
    ...
    public static final String MINIMUM_CONNECTION = "minimumConnection";
